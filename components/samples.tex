...
The SM background in this analysis is mostly dominated by the \Zjets process. The other main sources of the background besides \Zjets are the non-resonant production of $\ell$ and \ptmiss final states, including $t\bar{t}$ and $WW$ processes, and the resonant background from SM production of diboson events, composed mainly of $ZZ$ and $WZ$ processes. 
